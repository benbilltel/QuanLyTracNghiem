**Project Description**: Mutiple choice management project. Admin can manage student, class, subject and question by CRUD methods. Student can enroll exam and check result by id.
